import{d as ld,w as ni}from"./index.3e2485af.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bd="FirebaseError";class Me extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=bd,Object.setPrototypeOf(this,Me.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,xn.prototype.create)}}class xn{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?Cd(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Me(r,a,s)}}function Cd(t,e){return t.replace(kd,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const kd=/\{\$([^}]+)}/g;function Rd(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Rs(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const i=t[r],o=e[r];if(sa(i)&&sa(o)){if(!Rs(i,o))return!1}else if(i!==o)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function sa(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nf="firebase-heartbeat-database",Df=1,En="firebase-heartbeat-store";let Fr=null;function jc(){return Fr||(Fr=Qd(Nf,Df,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(En)}}}).catch(t=>{throw Je.create("idb-open",{originalErrorMessage:t.message})})),Fr}async function Of(t){try{return await(await jc()).transaction(En).objectStore(En).get(qc(t))}catch(e){if(e instanceof Me)wt.warn(e.message);else{const n=Je.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});wt.warn(n.message)}}}async function ca(t,e){try{const s=(await jc()).transaction(En,"readwrite");await s.objectStore(En).put(e,qc(t)),await s.done}catch(n){if(n instanceof Me)wt.warn(n.message);else{const s=Je.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});wt.warn(s.message)}}}function qc(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ff(t){_t(new et("platform-logger",e=>new Jd(e),"PRIVATE")),_t(new et("heartbeat",e=>new Lf(e),"PRIVATE")),ke(ii,aa,t),ke(ii,aa,"esm2017"),ke("fire-js","")}Ff("");var Vf="firebase",$f="9.23.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mn(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Me&&rv(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function rv({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qs extends Me{constructor(e,n,s,r){var i;super(n.code,n.message),this.operationType=s,this.user=r,Object.setPrototypeOf(this,Qs.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,r){return new Qs(e,n,s,r)}}function Mh(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?Qs._fromErrorAndOperation(t,i,e,s):i})}async function Cv(t,e,n=!1){const s=await Mn(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Jt._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kv(t,e,n=!1){const{auth:s}=t,r="reauthenticate";try{const i=await Mn(t,Mh(s,r,e,t),n);b(i.idToken,s,"internal-error");const o=Go(i.idToken);b(o,s,"internal-error");const{sub:a}=o;return b(t.uid===a,s,"user-mismatch"),Jt._forOperation(t,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Pe(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lh{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(Ys,"1"),this.storage.removeItem(Ys),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uh extends Lh{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}Uh.type="SESSION";const Fh=Uh;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u_(t){return t!==void 0}function l_(t){return typeof t=="object"&&!Array.isArray(t)}function Zo(t){return typeof t=="string"||t instanceof String}function bc(t){return ea()&&t instanceof Blob}function ea(){return typeof Blob<"u"&&!_d()}function Cc(t,e,n,s){if(s<e)throw Li(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw Li(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd="storage";function _E(t,e,n){return t=$(t),z_(t,e,n)}function EE(t){return t=$(t),H_(t)}function IE(t,e){return t=$(t),Q_(t,e)}function X_(t=Fi(),e){t=$(t);const s=Zs(t,cd).getImmediate({identifier:e}),r=Lc("storage");return r&&J_(s,...r),s}function J_(t,e,n,s={}){Y_(t,e,n,s)}function Z_(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new na(n,s,r,e,bt)}function eE(){_t(new et(cd,Z_,"PUBLIC").setMultipleInstances(!0)),ke(Rc,Nc,""),ke(Rc,Nc,"esm2017")}eE();const tE={apiKey:"AIzaSyBM3YmnQFBMGHCSKctw_hGUg_26k9wft7Y",authDomain:"fiahship-course.firebaseapp.com",projectId:"fiahship-course",storageBucket:"fiahship-course.appspot.com",messagingSenderId:"941632953232",appId:"1:941632953232:web:6f2cc6ac138be23f34b115",measurementId:"G-ER21DGH12Z"};Bc(tE);const nE=Ny(),cn=qw(),TE=X_();function sE(){let t;if(!cn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=ni(null);return{subscribe:n}}const{subscribe:e}=ni((cn==null?void 0:cn.currentUser)??null,n=>(t=Ov(cn,s=>{n(s)}),()=>t()));return{subscribe:e}}const rE=sE();function iE(t){let e;const n=ky(nE,t),{subscribe:s}=ni(null,r=>(e=jy(n,i=>{r(i.data()??null)}),()=>e()));return{subscribe:s,ref:n,id:n.id}}const SE=ld(rE,(t,e)=>{if(t)return iE(`users/${t.uid}`).subscribe(e);e(null)});export{Ke as G,gE as Q,cE as R,yE as W,aE as _,SE as a,cn as b,vE as c,TE as d,nE as e,pE as f,ky as g,EE as h,_E as i,hE as j,lE as k,uE as l,dE as m,mE as n,fE as o,IE as r,wE as s,rE as u};
